		...
		if(r)if(a&&s&&o) {
			...
			var C=new e.ShaderMaterial( {
				uniforms: {
					...
					, res: {
						type: "vec4", value:new e.Vector4(r.offsetWidth, r.offsetHeight, E, W)
					}
					, dpr: {
						type: "f", value:window.devicePixelRatio
					}
				}
